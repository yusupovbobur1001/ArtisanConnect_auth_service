...
func (c *authClient) GetByIdProfile(ctx context.Context, in *Id, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
func (UnimplementedAuthServer) GetByIdProfile(context.Context, *Id) (*UserInfo, error) {
